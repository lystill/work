...
class eventEngine(object):
    ...
    def __run(self):
        ...
        while self.__active == True:
            ...
            # print '__active==True'
            try:
                event = self.__queue.get(block=True, timeout=None)  # 获取事件的阻塞时间设为1秒

                self.__process(event)

                # print '000000000000000000000000000000000000000000Event: ',event.type_
                # print dir(event.dict_)
    ...
    def __process(self, event):
        ...
        # print event.type_,self.__handlers
        # print 'CHULISHIJIAN..........'
        #
        # """处理事件"""
        # 检查是否存在对该事件进行监听的处理函数
        if event.type_ in self.__handlers:
            # print "type++in +++handlers"
            # print event.type_,handler
